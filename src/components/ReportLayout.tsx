    ...
    <div className="flex-1 overflow-y-auto bg-slate-100 print:bg-white pb-24">
      <div className="max-w-3xl mx-auto bg-white shadow-sm print:shadow-none min-h-screen">
        ...
        <div className="p-6 md:p-10 border-b border-slate-200">
          {/* Phase Badge */}
          <div className="inline-block bg-amber-400 text-slate-900 text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded mb-4 mt-2">
          ...
          <div className="border border-slate-200 rounded-xl p-5">
            <h3 className="text-[10px] uppercase tracking-widest font-bold text-slate-500 text-center mb-4">
                  ...
                  <div>
                    ...
                    {fp ? (
                      <div className="relative w-full h-40 rounded-lg border border-slate-200 overflow-hidden bg-slate-50">
                        ...
                        {/* Pin indicator */}
                        <div
                          className="absolute w-5 h-5 bg-red-500 border-2 border-white rounded-full shadow-lg flex items-center justify-center text-[8px] font-bold text-white transform -translate-x-1/2 -translate-y-1/2"
