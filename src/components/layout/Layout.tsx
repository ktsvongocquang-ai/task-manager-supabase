    ...
    return (
        <div className="h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex font-inter">
            ...
            <main className="flex-1 lg:ml-64 flex flex-col h-screen relative bg-app-bg pb-16 md:pb-0 min-w-0">
                ...
                {/* Page View */}
                <div className={`flex-1 overflow-y-scroll w-full max-w-full flex flex-col relative min-w-0 ${location.pathname.startsWith('/customers') || location.pathname === '/schedule' ? '' : 'p-3 sm:p-6'}`}>
                    <Outlet />
                </div>
            </main>
