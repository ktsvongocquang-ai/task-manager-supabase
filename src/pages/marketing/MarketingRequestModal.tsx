...
export default function MarketingRequestModal({ isOpen, onClose }: MarketingRequestModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-[#222] rounded-xl shadow-xl w-full max-w-3xl my-8 max-h-[90vh] flex flex-col">
        <div className="flex justify-between items-center p-6 border-b border-[#333] bg-[#222] rounded-t-xl shrink-0">
          <div>
            <h2 className="text-xl font-bold text-slate-50">Form Cung Cấp Thông Tin Marketing</h2>
            <p className="text-sm text-slate-400 mt-1">Điền đầy đủ thông tin để team Marketing có chất liệu lên nội dung</p>
          </div>
          <button onClick={onClose} className="text-gray-400 hover:text-gray-600 p-2 hover:bg-[#2a2a2a] rounded-full transition-colors">
            <X className="w-6 h-6" />
          </button>
        </div>
        ...
        <div className="p-6 space-y-6 overflow-y-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="col-span-2 md:col-span-1">
              <label className="block text-sm font-medium text-slate-200 mb-1">Tên công trình <span className="text-red-500">*</span></label>
            ...
            {/* Loại công trình */}
            <div className="col-span-2 md:col-span-1">
              <label className="block text-sm font-medium text-slate-200 mb-1">Loại công trình <span className="text-red-500">*</span></label>
            ...
            {/* Tình trạng */}
            <div>
              <label className="block text-sm font-medium text-slate-200 mb-1">Tình trạng <span className="text-red-500">*</span></label>
              <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
            ...
            {/* Trạng thái cập nhật */}
            <div>
              <label className="block text-sm font-medium text-slate-200 mb-1">Trạng thái cập nhật hình ảnh</label>
              <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
            ...
            {/* Ngày thi công */}
            <div>
              <label className="block text-sm font-medium text-slate-200 mb-1">Ngày thi công</label>
            ...
            {/* Ngày hoàn thiện */}
            <div>
              <label className="block text-sm font-medium text-slate-200 mb-1">Ngày hoàn thiện (dự kiến)</label>
              <input type="date" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent" />
            </div>

            {/* Địa chỉ */}
            <div className="col-span-2">
              <label className="block text-sm font-medium text-slate-200 mb-1">Địa chỉ</label>
            ...
            <div className="col-span-2">
              <label className="block text-sm font-medium text-slate-200 mb-2">Có thể đến quay video không?</label>
            ...
            {/* Kiểu hiệu ứng */}
            <div className="col-span-2">
              <label className="block text-sm font-medium text-slate-200 mb-2">Kiểu hiệu ứng (Có thể chọn nhiều)</label>
              <div className="flex flex-wrap gap-3">
                {['Đất nện', 'Bê tông', 'Stucco', 'Đá khối'].map(effect => (
                  <label key={effect} className="flex items-center gap-2 bg-[#1c1c1c] px-3 py-2 rounded-lg border border-[#333] cursor-pointer hover:bg-[#2a2a2a] transition-colors">
            ...
            {/* Mô tả kiểu hiệu ứng */}
            <div className="col-span-2">
              <label className="block text-sm font-medium text-slate-200 mb-1">Mô tả kiểu hiệu ứng</label>
            ...
            {/* Mô tả về công trình */}
            <div className="col-span-2">
              <label className="block text-sm font-medium text-slate-200 mb-1">Mô tả về công trình</label>
            ...
            <div className="col-span-2">
              <label className="block text-sm font-medium text-slate-200 mb-1">Vấn đề công trình / khách hàng gặp phải</label>
              <p className="text-xs text-slate-400 mb-2">Những khó khăn, mong muốn được giải quyết của khách hàng</p>
            ...
            {/* Giải pháp DQH */}
            <div className="col-span-2">
              <label className="block text-sm font-medium text-slate-200 mb-1">Giải pháp mà DQH mang lại</label>
            ...
            {/* Link tài liệu */}
            <div className="col-span-2">
              <label className="block text-sm font-medium text-slate-200 mb-1">Hình ảnh / Videos của công trình</label>
            ...
            {/* Thông tin khác */}
            <div className="col-span-2">
              <label className="block text-sm font-medium text-slate-200 mb-1">Thông tin khác (nếu có)</label>
        ...
        <div className="p-6 border-t border-[#333] bg-[#1c1c1c] rounded-b-xl flex justify-end gap-3 shrink-0">
          <button onClick={onClose} className="px-4 py-2 text-sm font-medium text-slate-200 bg-[#222] border border-gray-300 rounded-lg hover:bg-[#1c1c1c] transition-colors">
            Hủy
          </button>
