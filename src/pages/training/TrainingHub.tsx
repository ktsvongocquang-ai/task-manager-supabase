...
const FALLBACK_WORKFLOWS: Workflow[] = [
  ...
  { id: "w_present", module_id: "m3", slug: "presentation-skills", number: "3.7", title: "Kỹ năng giao tiếp & Thuyết trình", description: "Kỹ năng trình bày, giao tiếp KH", icon: "Megaphone", lead_quote: "Thiết kế giỏi mà trình bày kém = mất khách. Giao tiếp tốt = chốt deal nhanh.", checklist: null, sort_order: 7, created_at: "", updated_at: "" },
  { id: "w_asbuilt", module_id: "m3", slug: "as-built-docs", number: "3.8", title: "Hồ sơ hoàn công", description: "Quy trình lập & bàn giao hồ sơ hoàn công", icon: "ClipboardList", lead_quote: "Hoàn công đầy đủ = bảo vệ công ty + tạo niềm tin với khách hàng.", checklist: null, sort_order: 8, created_at: "", updated_at: "" },
  { id: "w8", module_id: "m3", slug: "change-order", number: "3.9", title: "Xử lý phát sinh", description: "Change request, change order", icon: "GitBranch", lead_quote: "Không có thay đổi miễn phí. Mọi thay đổi đều có giấy tờ — dù 0đ.", checklist: null, sort_order: 9, created_at: "", updated_at: "" },
];
