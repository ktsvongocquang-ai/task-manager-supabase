...
export default function FacebookAdsAnalyzer() {
    ...
    const renderMarkdown = (text: string) => {
        let html = text
            ...
            .replace(/^### (.*$)/gim, '<h3 class="text-lg font-bold mt-4 mb-2 text-slate-100">$1</h3>')
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-140px)] lg:h-[calc(100vh-180px)] bg-[#222] rounded-2xl shadow-sm border border-[#333] overflow-hidden relative">
            
            {/* Header */}
            <div className="px-6 py-4 border-b border-[#333] flex items-center justify-between shrink-0 bg-gradient-to-r from-blue-50 to-indigo-50/50">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-lg font-bold text-slate-100 tracking-tight">Giám Đốc Marketing AI</h2>
                ...
                <button 
                    ...
                    className="p-2.5 bg-[#222] text-slate-600 hover:text-indigo-600 rounded-xl border border-[#333] hover:border-indigo-200 shadow-sm transition-all focus:outline-none"
            ...
            {/* Quick Actions */}
            <div className="px-6 py-3 border-b border-[#333] bg-[#222] flex flex-wrap gap-3 shrink-0">
                <button 
            ...
            {/* Settings Modal */}
            <div className={`absolute top-0 right-0 bottom-0 w-full sm:w-96 bg-[#222] border-l border-[#333] shadow-2xl z-20 transition-transform duration-300 transform ${isSettingsOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                <div className="flex flex-col h-full">
                    <div className="px-6 py-5 border-b border-[#333] flex items-center justify-between bg-[#1c1c1c]">
                        <h3 className="font-bold text-slate-100">Cấu hình DB & API</h3>
                    ...
                    <div className="p-6 flex-1 overflow-y-auto space-y-5">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                className="w-full px-4 py-2.5 bg-[#1c1c1c] border border-[#333] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 font-mono"
                            />
                        </div>
                        <div>
                            ...
                            <textarea 
                                ...
                                placeholder="EAAI..."
                                rows={4}
                                className="w-full px-4 py-2.5 bg-[#1c1c1c] border border-[#333] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 font-mono resize-none relative"
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6 bg-[#1c1c1c]" style={{ scrollBehavior: 'smooth' }}>
                <div className="max-w-5xl mx-auto space-y-10">
                            ...
                            <div key={report.id || idx} className={`flex ${isUserPrompt ? 'justify-end' : 'justify-start'}`}>
                                <div className={`flex w-full ${isUserPrompt ? 'max-w-[75%] gap-3 items-end flex-row-reverse' : 'gap-4 items-start flex-col sm:flex-row'}`}>
                                    ...
                                    <div className="flex-1 w-full min-w-0">
                                        ...
                                        {/* System / Error Bubble */}
                                        {isSystem && (
                                            <div className="px-5 py-4 bg-[#222] border border-[#333] text-slate-200 rounded-2xl shadow-sm text-center mx-auto max-w-md">
                                        ...
                                        {!isUserPrompt && !isSystem && (
                                            <div className="bg-[#222] border border-[#333] rounded-2xl overflow-hidden shadow-sm">
                                                
                                                {/* Card Header */}
                                                <div className="px-6 py-4 border-b border-[#333] bg-[#1c1c1c] flex items-center justify-between">
                                                ...
                                                <div className="p-6 lg:p-8">
                                                    <div className="prose prose-sm lg:prose-base prose-indigo max-w-none prose-headings:font-bold prose-p:text-slate-200">
                    ...
                    {isLoading && (
                        <div className="flex gap-4 items-start">
                            ...
                            <div className="px-5 py-4 rounded-2xl bg-[#222] border border-[#333] text-slate-200 shadow-sm flex items-center gap-3">
            ...
            {/* Input Area */}
            <div className="p-4 sm:p-6 bg-[#222] border-t border-[#333] shrink-0">
                <div className="max-w-4xl mx-auto relative flex items-end">
                    <textarea 
                        ...
                        className="w-full bg-[#1c1c1c] border border-[#333] rounded-2xl pl-5 pr-14 py-4 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 resize-none min-h-[60px] max-h-[150px] transition-all scrollbar-hide text-slate-200"
                        rows={1}
                        onInput={(e) => {
